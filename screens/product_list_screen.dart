import 'dart:convert';
import 'package:crud/screens/product.dart';
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: inProgress
          ...
          separatorBuilder: (_, __) => const Divider(),//separatorBuilder = item-এর মাঝখানে কী দেখাবো Divider = একটা horizontal line
            //line / space / widget দরকার → ListView.separated
        ),
      ),
